...
export function QuestionCard({
  ...
  const shouldShowQuestion = () => {
    ...
    const dependentResponse = allResponses[question.conditional_logic.dependsOn]?.value
    if (dependentResponse === undefined) return false

    switch (question.conditional_logic.condition) {
      case 'equals':
        return dependentResponse === question.conditional_logic.value
      case 'not_equals':
        return dependentResponse !== question.conditional_logic.value
      case 'greater_than':
        return dependentResponse > question.conditional_logic.value
  ...
  // Don't render anything if conditional logic says to hide
