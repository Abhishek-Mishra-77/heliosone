...
BEGIN
  ...
  DROP TABLE IF EXISTS resiliency_responses CASCADE;
  DROP TABLE IF EXISTS resiliency_questions CASCADE;
  DROP TABLE IF EXISTS resiliency_categories CASCADE;

  -- Create Resiliency Categories table
  ...
  -- Create Resiliency Questions table
  ...
  -- Create Resiliency Responses table
